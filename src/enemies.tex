...
\begin{itemize}
	...
	\item \hyperlink{enem:Blast_Raster}{\textbf{Blast Raster} (X4)}
...
%%
	...
	\enemSpecs{6, weak to Parasitic Bomb and Spinning Blade}{1 (projectiles), 6(contact)}{\hyperlink{enem:Head_Gunner_masspro}{Head Gunner} with cannons attached, as well as a stronger armor. Made from the parts produced in the weapons factory stage.}
	
	\item[{\includegraphics[height=20px]{figures/X3/Enemies/headgunnermasspro.png}}] \hypertarget{enem:Head_Gunner_masspro}{\textbf{Head Gunner masspro} (X3)}:\enemSpecs{4, weak to Parasitic Bomb and Spinning Blade}{1 (projectiles), 4 (contact)}{Basic model \hyperlink{enem:Head_Gunner_customer}{Head Gunner} mechaniloid, equipped with 2 missile guns. It has legs attached, but cannot walk.}
	...
	\enemSpecs{7 total, 3 (Rock shell), 4 (core), regenerates shell after some time}{2 (debris), 2 (contact-core), 6 (contact-shell)}{Variation of \hyperlink{enem:Ball_De_Voux}{Ball De Voux}. Like \hyperlink{enem:Ice_De_Voux}{Ice De Voux}, there is no walking function, but it can call upon chunks of rock for protection.}
	...
	%	K
	%%
	\item \hyperlink{enem:Kill_Fisher}{\textbf{Kill Fisher} (X4)}
	\item \hyperlink{enem:King_Poseidon}{\textbf{King Poseidon} (X4)}	
	...
	\item \hyperlink{enem:Mega_Nest}{\textbf{Mega Nest} (X4)}
	...
	\item \hyperlink{enem:Metal_Gabyoall}{\textbf{Metal Gabyoall} (X4)}
	
	\item \hyperlink{Metal_Hawk}{Metal Hawk (X4)}
...
%	O
%%
	\item \hyperlink{enem:Obiiru}{\textbf{Obiiru} (X4)}
...
%%
	...
	\enemSpecs{2, weak to Strike Chain and Crystal Hunter}{2 (contact)}{\hyperlink{enem:Pararoid_V-1}{Pararoid} model improved with the ability of flight. It can approach suddenly by dashing at super speed.}
	...
	\item \hyperlink{Plasma_Cannon}{Plasma Cannon (X4)}
	...
	\item \hyperlink{enem:Spider_Core}{\textbf{Spider Core} (X4)}
	...
	\item \hyperlink{Walk_Shooter}{Walk Shooter (X4)}
