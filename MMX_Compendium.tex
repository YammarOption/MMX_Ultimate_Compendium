...
\warningbox{\small{
		\begin{itemize}	
				...
				\item The events of Bass' endings in both \textit{Mega Man: The Power Battle} and \textit{ Mega Man 2: The Power Fighters} are considered to happened, as they do not contradict any other statement from other games and also provide a little more insight on Zero's origins.
				...
				\item The final battle against X and Vile mk.II takes place within Doppler's laboratory (instead of Volt Kurageil).
		\end{itemize}
	}
}
